          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <p className={`text-sm flex items-center ${usernameMessage === "Username is available" ? 'text-green-500' : 'text-red-500'}`}>
                {usernameMessage}
                {usernameMessage === "Username is available" && (
                  <Verified className="ml-1 w-4 h-4" />
                )}
                {usernameMessage != 'Username is available' && usernameMessage &&  (
